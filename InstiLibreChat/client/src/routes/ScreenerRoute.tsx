    ...
    <div className="h-full flex flex-col bg-white dark:bg-gray-850">
      ...
      <div className="flex-1 overflow-auto p-6">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <button className="px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800 flex items-center gap-2">
